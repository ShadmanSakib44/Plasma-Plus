...
<head>
    ...
    <title>PLASMA PLUS CHAT</title>
	<link rel="shortcut icon" type="image/x-icon" href="/chat_part/images/logo.png" />
...
<!--          drop-down-->
          <div id="myDropdown" class="dropdown">
                     <div id="myDropdown" class="dropdown-content">
                        ...
                        <a href="/plasmaplus/plasmaplus/home.php">Back</a>
                    </div>
     			</div>
<!--          heading-->
<!-- back button -->
...
<div class="row heading"  style="background-color:#F75D58;">
...
<!--        right info-->
        ...
        <div class='right-side-one 'id="clickedprofile">
			...
			<form>
                <div class="profileimage">			
					<img src="<?php echo $clicked_profile ?>" ><br><br>
    			</div>
				<div class="box">
					<div class="profiletext">
